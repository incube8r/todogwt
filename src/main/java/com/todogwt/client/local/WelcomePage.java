...
import com.todogwt.client.local.event.Delete;
import com.todogwt.client.local.event.Updated;
import com.todogwt.client.local.model.Todo;
import com.todogwt.client.local.model.TodoWrapper;
import com.todogwt.client.local.repository.TodoRepository;
import com.todogwt.client.local.widget.TodoItem;
...
public class WelcomePage extends Composite {
    ...
    public void showing() {
        countTodos();
        rows.clear();
        repository.listTodo(new Callback<List<Todo>>() {
            @Override
    ...
    public void deleted(@Observes @Delete TodoWrapper wrapper) {
        if(wrapper != null && wrapper.getTodo() != null) {
            ...
            repository.remove(todo.getIndex());
